    ...
    def forward(self, sentence):
        ...
        for i, w in enumerate(sentence):
            ...
            if i == 0:
                ...
                for t in self.tagset:
                    sum_terms = [(self.emission(t, w) + self.transition(t_1, t) + alpha[(i-1, t_1)]) for t_1 in self.tagset]
    ...
    def build_viterbi_delta(self, sentence):
        ...
        for i, w in enumerate(sentence):
            ...
            if i == 0:
                ...
                for t in self.tagset:
                    max_term = max([(self.transition(t_1, t) + delta[(i - 1, t_1)], t_1) for t_1 in self.tagset])
